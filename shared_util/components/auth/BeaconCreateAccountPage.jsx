// ============================================================================
// BEACON CREATE ACCOUNT PAGE - Beacon Emergency App account creation functionality
// ============================================================================

import React, { useState } from 'react'
import '../../../../../frontend/src/pages/CreateAccountPage.css'
import { createUser } from '../../../funcs/user_mngr/index.js'

function BeaconCreateAccountPage({ 
  appName = "Beacon", 
  appLogo,
  appColor = "#0b0f2a",
  welcomeTitle,
  ...
  const createAccount = async (userData) => {
    try {
      ...
      // Use the Groups user management system
      ...
      console.error('Error creating Groups account:', error)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Create the account using Groups user management system
      const result = await createAccount(formData)
      
      if (result.success) {
        setSuccess('Account created successfully!')
        
        // Store current user session using Groups format
        localStorage.setItem('groups_current_user', JSON.stringify(result.user))
      ...
      console.error('Groups account creation error:', err)
...
export default BeaconCreateAccountPage